...
#課題３
#リクエストURL
url_productSearch = "https://app.rakuten.co.jp/services/api/Product/Search/20170426?format=json&applicationId=1017111620275786286&keyword={}"
keyword = "Pythonプログラミング"

#リクエスト実行
response_product = req.get_api(url_productSearch.format(keyword))
